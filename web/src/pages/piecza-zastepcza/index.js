...
const FosterCare = () => (
    <Layout>
        ...
        <Link to='rodziny-rdd'><div>Rodziny zastępcze i rodzinne domy dziecka</div></Link>
        <Link to='wychowankowie'><div>Usamodzielnieni wychowankowie</div></Link>
        <Link to='rodzice'><div>Rodzice dzieci w pieczy zastępczej</div></Link>
    </Layout>
)
